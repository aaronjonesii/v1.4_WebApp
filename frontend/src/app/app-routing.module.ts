...
import { FrontendAdminGuard } from "./shared/utils/frontend-admin.guard";


const routes: Routes = [
  { path: '', loadChildren: () => import('./pages/home/home.module').then(m => m.HomeModule) },
  { path: 'error', component: ServerErrorComponent },
  { path: 'admin', loadChildren: () => import('./pages/admin/admin.module').then(m => m.AdminModule), canActivate: [FrontendAdminGuard] },
