...
export class ServerErrorComponent implements OnInit, OnDestroy {
  ...
  minutes_of_countdown = 5;
  counter_in_seconds = this.minutes_of_countdown*60
  hrefContactUs = 'mailto:anonsystems@protonmail.com' +
    '?subject=Website Server Errors' +
    '&body=Unable to connect to server(anonsys.tech), I was on … page and wanted to … ';
