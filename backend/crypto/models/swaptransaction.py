...
class SwapTransaction(models.Model):
    ...
    from_token = models.ForeignKey('CryptoToken', on_delete=models.PROTECT, related_name='swaps_from_token', db_column='from_token', help_text='Token swapped from')
    ...
    to_token = models.ForeignKey('CryptoToken', on_delete=models.PROTECT, related_name='swaps_to_token', db_column='to_token', help_text='Token swapped to')
